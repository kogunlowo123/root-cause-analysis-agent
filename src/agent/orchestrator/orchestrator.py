"""Root Cause Analysis Agent — Agent Orchestrator (Plan → Research → Execute → Validate → Respond)."""
...
class AgentOrchestrator:
    """Orchestrates the Root Cause Analysis Agent through a multi-step pipeline.
