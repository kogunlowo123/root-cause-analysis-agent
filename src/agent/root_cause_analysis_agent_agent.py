"""Root Cause Analysis Agent - Main Agent Implementation."""
...
class RootCauseAnalysisAgentAgent:
    """
    ...
    def __init__(self):
        ...
        self.metric_correlation_enabled = True
        self.trace_analysis_enabled = True
        self.change_correlation_enabled = True
        self.causal_chain_enabled = True
        self.rca_reporting_enabled = True
        self._tool_dispatch = {
            "correlate_signals": self.tools.correlate_signals,
            "analyze_traces": self.tools.analyze_traces,
            "find_change_correlation": self.tools.find_change_correlation,
            "build_causal_chain": self.tools.build_causal_chain,
            "generate_rca_report": self.tools.generate_rca_report,
        }
        logger.info(
            "agent_initialized",
            ...
            features=['metric_correlation', 'trace_analysis', 'change_correlation', 'causal_chain', 'rca_reporting'],
        )
    ...
    async def _maybe_execute_tools(self, message: str, context: str) -> list[dict]:
        ...
        tool_keywords = {
            "correlate_signals": ['correlate', 'signals'],
            "analyze_traces": ['analyze', 'traces'],
            "find_change_correlation": ['find', 'change', 'correlation'],
            "build_causal_chain": ['build', 'causal', 'chain'],
